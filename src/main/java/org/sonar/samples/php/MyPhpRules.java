...
import org.sonar.samples.php.checks.*;
...
public class MyPhpRules implements RulesDefinition, PHPCustomRuleRepository {
  ...
  public ImmutableList<Class> checkClasses() {
    return ImmutableList.of(ForbiddenFunctionUseCheck.class,
            ...
            OWASP_A9_2017Check.class,
            OWASP_A4_2017Check.class,
            SecureRandomCheck.class);
  }

  @Override
  public void define(Context context) {
    NewRepository repository = context.createRepository(repositoryKey(), "php").setName("Lucia Kokuľová Repository");
    ...
    remediationCosts.put(SQLInjectionCheck.KEY, "10min");
    remediationCosts.put(OWASP_A9_2017Check.KEY, "10min");
    remediationCosts.put(OWASP_A4_2017Check.KEY, "10min");
    remediationCosts.put(SecureRandomCheck.KEY, "10min");
